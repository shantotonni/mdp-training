                                        ...
                                        <tbody>
                                          <tr v-for="(plan, i) in action_plan" :key="plan.ID" v-if="action_plan.length">
                                              ...
                                              <td class="text-center">
                                                <router-link :to="`action-plan-edit/${plan.ID}`" class="btn btn-info btn-sm"><i class="mdi mdi-square-edit-outline"></i> Edit</router-link>
                                                <router-link :to="`action-plan-print/${plan.ID}`" class="btn btn-info btn-sm"><i class="mdi mdi-printer"></i> Print</router-link>
  ...
  mixins: [Common],
    ...
    methods: {
      ...
      exportActionPlanList(){
        axios.get(baseurl + 'api/export-action-plane-list')
            .then((response)=>{
