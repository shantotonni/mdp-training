<template>
  <div class="content">
    <div class="container-fluid">
      <breadcrumb :options="['Edit Action Plan']">
        <div class="col-sm-6">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <div class="form-group">
                                ...
                                <input type="text" name="StaffID" id="StaffID" v-model="form.StaffID" class="form-control" readonly :class="{ 'is-invalid': form.errors.has('StaffID') }" @change="getEmployeeByStaffID">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="datatable" v-if="!isLoading">
                    <div class="card-body">
                      <div class="col-md-12">
                        <p style="font-size: 13px;font-weight:bold;color:#0000B9">Agreed Action Plan for the Period : {{ this.form.ActionPlanPeriod }}</p>
                        <hr>
                        <div class="row">
                          <div class="col-4 col-md-4">
...
export default {
  ...
  methods: {
    getEditData(){
      axios.get(baseurl + `api/action-plane-edit/${this.$route.params.ID}`).then((response)=>{
        console.log(response)
        this.form.fill(response.data.action_plan);
        this.getAllDivision();
    ...
    update(){
      this.form.busy = true;
      this.form.post(baseurl + "api/action_plane_update").then(response => {
        console.log(response)
