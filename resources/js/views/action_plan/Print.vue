                            ...
                            <div class="card-body">
                              <div class="first_part">
                                ...
                                <p style="font-size: 20px">
                                  Name of employee <span style="display: inline-block;border-bottom: 1px solid;width: 210px;text-align: center">{{ action_plan.EmployeeName }}</span>
                                  Position <span style="display: inline-block;border-bottom: 1px solid;width: 300px;text-align: center">{{ action_plan.Designation }}</span>
                                  Staff Id <span style="display: inline-block;border-bottom: 1px solid;width: 100px;text-align: center">{{ action_plan.StaffID }}</span>
                                </p>
                                <p style="font-size: 20px">
                                  Name of Supervisor <span style="display: inline-block;border-bottom: 1px solid;width: 200px;text-align: center">{{ action_plan.SuppervisorName }}</span>
                                  Position <span style="display: inline-block;border-bottom: 1px solid;width: 300px;text-align: center">{{ action_plan.SuppervisorDesignation }}</span>
                              ...
                              <div class="first_part">
                                ...
                                <p>(You may insert new rows if it is required)</p>
                              </div>
