                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="SuppervisorDesignation"    v-model="form.SuppervisorDesignation" class="form-control"
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="SuppervisorEmail"  v-model="form.SuppervisorEmail" class="form-control" :class="{ 'is-invalid': form.errors.has('SuppervisorEmail') }" required>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="SuppervisorMobile"   v-model="form.SuppervisorMobile" class="form-control"
