          ...
          <div class="card">
            <div class="datatable" v-if="!isLoading">
              <div class="card-body">
                ...
                <div class=”header” style="position: fixed;height:100px;top: 0;background: red">Header</div>
                <div class=”footer” style="position: fixed;height:100px;top: 0;bottom:0;background: green">Footer</div>
